...
#ifndef __COOL_IDIOM_TRAIT_NONCOPYABLE_HPP_INCLUDED__
#define __COOL_IDIOM_TRAIT_NONCOPYABLE_HPP_INCLUDED__
...
#endif 	// __COOL_IDIOM_TRAIT_NONCOPYABLE_HPP_INCLUDED__
